...
public class SearchResult {
    ...
    public static class DataBean {
        private TbkDgMaterialOptionalResponseDataBean tbk_dg_material_optional_response;

        public TbkDgMaterialOptionalResponseDataBean getTbk_dg_material_optional_response() {
            return tbk_dg_material_optional_response;
        }

        public void setTbk_dg_material_optional_response(TbkDgMaterialOptionalResponseDataBean tbk_dg_material_optional_response) {
            this.tbk_dg_material_optional_response = tbk_dg_material_optional_response;
        }

        public static class TbkDgMaterialOptionalResponseDataBean {
            private ResultListDataBean result_list;
            private int total_results;
            private String request_id;

            public ResultListDataBean getResult_list() {
                return result_list;
            }

            public void setResult_list(ResultListDataBean result_list) {
            ...
            public static class ResultListDataBean {
                private List<MapDataDataBean> map_data;

                public List<MapDataDataBean> getMap_data() {
                    return map_data;
                }

                public void setMap_data(List<MapDataDataBean> map_data) {
                    this.map_data = map_data;
                }

                public static class MapDataDataBean implements ILinearItemInfo {
